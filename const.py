BIRDS_DICT={
    0:["Turdus merula", "Common Blackbird"],
    1:["Passer domesticus", "House Sparrow"],
    2:["Parus major", "Great Tit"],
    3:["Columba palumbus", "Wood Pigeon"],
    4:["Erithacus rubecula", "European Robin"],
    5:["Pica_pica", "Eurasian Magpie"],
    6:["Cyanistes caeruleus", "Eurasian Blue Tit"],
    7:["Sturnus vulgaris", "Common Starling"],
